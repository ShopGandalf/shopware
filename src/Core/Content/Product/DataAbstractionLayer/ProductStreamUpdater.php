...
class ProductStreamUpdater extends AbstractProductStreamUpdater
{
    ...
    public function handle(EntityIndexingMessage $message): void
    {
        ...
        try {
            $newMatches = $message->getContext()->enableInheritance(fn (Context $context): array => $this->searchMatchingProductIds($parsedFilters, null, $context));
    ...
    public function updateProducts(array $ids, Context $context): void
    {
        ...
        foreach ($streams as $stream) {
            ...
            try {
                $matches = $this->searchMatchingProductIds($parsedFilters, $ids, $context);
            } catch (UnmappedFieldException) {
